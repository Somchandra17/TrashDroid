#!/usr/bin/env python3
"""
gen_html.py — deterministic VAPT HTML report generator (bundled into every TrashDroid ai_review package).
...
def _derive_stats(html_body: str) -> str:
    ...
    Columns are fixed by TrashDroid's PROMPT triage table:
